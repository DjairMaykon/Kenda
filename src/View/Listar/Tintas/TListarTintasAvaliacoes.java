 ...
 * @author Djair Maykon
 */
public class TListarTintasAvaliacoes extends javax.swing.JInternalFrame {
    
    /**
     * Creates new form TNovoPedido
     */
    public TListarTintasAvaliacoes() {
        initComponents();
    ...
    public JTable getjTListarTintasAvaliacao() {
        return jTListarTintasAvaliacao;
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Lista de Tintas em Avalição");

        jPanel1.setBackground(new java.awt.Color(57, 93, 117));
        jPanel1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jTListarTintasAvaliacao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Codigo Avaliacao", "Codigo Tinta", "Codigo Funcionario", "Avaliacao", "Data"
            }
        ));
        jScrollPane1.setViewportView(jTListarTintasAvaliacao);

 ...
 * @author Djair Maykon
 */
public class TListarProducaoEmAndamento extends javax.swing.JInternalFrame {
    
    /**
     * Creates new form TNovoPedido
     */
    public TListarProducaoEmAndamento() {
        initComponents();
    ...
    public JTextField getjTFListarProducaoEmAndamento() {
        return jTFEntradaPesquisa;
    }

    public JTable getjTListarProducaoEmAndamento() {
        return jTListarProducaoEmAndamento;
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Listar de Produção em Andamento");
